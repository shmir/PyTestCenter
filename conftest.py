...
def pytest_addoption(parser):
    ...
    parser.addoption('--port1', action='store', default="10.212.8.8/6/7", help="chassis1/module1/port1")
    parser.addoption('--port2', action='store', default="10.212.8.8/6/7", help="chassis2/module2/port2")
